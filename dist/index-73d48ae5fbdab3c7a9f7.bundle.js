        ...
        switch (_context6.prev = _context6.next) {
          ...
          case 2:
            ...
            if (previousRound.data[0].playerId === null && previousRound.data[0].skipCounter === null) {
              ...
              cardCombination.innerHTML = "The combination is ".concat(previousRound.data[1].cardsPlayed.length, " cards, ").concat(previousRound.data[0].player, " has played his turn, it is the next player's turn");
